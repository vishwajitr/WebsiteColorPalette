...
(function( $ ) {
    $.fn.iaoAlert = $.iaoAlert = function(arr) {
        ...
        var timeStamp = $.now();
        var ext = {
            chkPosition : (opt.position == 'bottom-right')?'bottom-right':(((opt.position == 'bottom-left')?'bottom-left':(opt.position == 'top-left')?'top-left':(opt.position == 'top-right')?'top-right':'top-center')),
        ...
        $('body').append('<iao-alert-box position="top-left"><iao-alert-start></iao-alert-start></iao-alert-box><iao-alert-box position="top-right"><iao-alert-start></iao-alert-start></iao-alert-box><iao-alert-box position="bottom-right"><iao-alert-start></iao-alert-start></iao-alert-box><iao-alert-box position="bottom-left"><iao-alert-start></iao-alert-start></iao-alert-box><iao-alert-box position="top-center"><iao-alert-start></iao-alert-start></iao-alert-box>');
